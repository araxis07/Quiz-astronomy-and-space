...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function showQuestion() {
        ...
        if (currentQuestionIndex < questions.length) {
            ...
            currentQuestion.choices.forEach(function (choice, index) {
                ...
                button.addEventListener('click', function () { return selectAnswer(index); });
    ...
    function selectAnswer(selectedIndex) {
        ...
        Array.from(choicesElement.children).forEach(function (button, index) {
    ...
    function showResult() {
        ...
        scoreElement.textContent = "\u0E04\u0E38\u0E13\u0E44\u0E14\u0E49\u0E04\u0E30\u0E41\u0E19\u0E19 ".concat(score, " \u0E08\u0E32\u0E01 ").concat(questions.length, " \u0E02\u0E49\u0E2D");
    }
